...
Some helpful tips for writing the reward function code:
    ...
    (2) Design reward components that are as independent from each other as possible, and aim to include multiple distinct reward components as many as possible.
